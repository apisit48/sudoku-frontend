<template>
  <article class="leaderboard">
    <header>
      ...
      <h1 class="leaderboard__title"><span class="leaderboard__title--top">Sudoku</span><span class="leaderboard__title--bottom">Leaderboard</span></h1>
    </header>
    ...
    <main class="leaderboard__profiles" 
      ...
      <article class="leaderboard__profile" >
        <span class="leaderboard__picture text-center">{{ index+1 }}</span>
        <span class="leaderboard__name">{{ item.username }}</span>
        <span class="leaderboard__value">{{ item.winrate }}<span>W/L</span></span>
      </article>
    </main>
  </article>
</template>
